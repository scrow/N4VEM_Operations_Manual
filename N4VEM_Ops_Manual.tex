...
\author            {Maintained by:\\Matt Kimball K4MTK\\Steve Crow KG4PEQ\\Reid Barden N1VCU\\Tim Farrell KJ4NPB}
\date              {17-Jan-2016}
\newcommand\docver {v1.0.0}
...
The Radio Room Supervisor is available to assist all operators with any challenges that may arise, including frequency conflict resolution and equipment trouble.  Please utilize the Radio Room Supervisor as necessary.
...
\begin{itemize}
	...
	\item notes on any equipment issues, frequency changes, or other communications challenges encountered during the shift, as well as any recommendations for workarounds; and
	\item report from the ARCA Radio Log.
\end{itemize}

The brief summary and notes should be provided to the incoming Supervisor.
...
The last Radio Operators and the final Supervisor should ensure that the radio equipment is returned to its default settings as prescribed in the documentation in the radio room.  All radios should be powered off, computers should be shut down, all folders and other paperwork should be neatly organized, and all trash should be disposed of in the proper receptacles.
...
ARCA members are allowed to borrow equipment provided it is not immediately needed by the group. You must gain permission from the Technical Secretary, President, or VDEM Amateur Radio Liaison.  You must sign out the equipment immediately using the official log located in the radio room. You may borrow equipment for up to 30 days or until requested to return such items.
